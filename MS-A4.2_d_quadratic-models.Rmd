...
A rock is thrown from a cliff. The height $h$ of the rock after time $t$ is given by $h=-\dfrac{1}{2}x+2x+6$.

a) Draw the graph of $h=-\dfrac{1}{2}x+2x+6$.
...
* $\dfrac{v^2}{10}$ is the braking distance 
